...
export default function Feautures({}: Props) {
  return (
    <center className='mt-28'>
            ...
            <p className='mt-3 font-normal text-gray-500'>Dub.co is more than just a link shortener. We've built a suite of powerful features that gives you marketing superpowers.</p>
